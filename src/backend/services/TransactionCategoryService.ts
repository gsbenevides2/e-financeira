...
export class TransactionCategoryService {
  ...
  static async create(dto: CreateTransactionCategoryDto): Promise<TransactionCategory> {
  ...
  static async addTransaction(categoryId: UUID, transactionId: UUID): Promise<void> {
