...
export const TransactionLinkForm: React.FC<TransactionLinkFormProps> = (
    ...
    const loadData = async () => {
        try {
            ...
            const linkedPromise = apiClient.api.transactions({
                id: transaction.id
            }).related.get();
            ...
            const checkLinked = isSuccessStatus(linkedResponse.status) && linkedResponse.data;

            if (!checkTransactions || !checkAccounts || !checkCategories || !checkLinked) {
