...
export function TransactionList() {
	...
	}, [monthReferences, selectedMonthReference]);
	...
	}, [searchQuery, selectedAccount, selectedCategory, selectedMonthReference]);
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
					...
					<div>
						...
						<select
							...
							onChange={(e) => setSelectedMonthReference(e.target.value)}
							className="cursor-pointer w-full px-3 py-2 border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-gray-700 text-gray-200"
						>
			...
			<div className="bg-gray-800 rounded-lg shadow overflow-hidden border border-gray-700">
				...
				{loading ? (
					<div className="flex justify-center items-center p-8">
						<div className="text-gray-300">Carregando transações...</div>
					</div>
